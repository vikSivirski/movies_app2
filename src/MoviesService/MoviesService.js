export default class MoviesService {
  ...
  async getRatedMovies(sessionId, page = 1) {
    const res = await this.getResource(
      `https://api.themoviedb.org/3/guest_session/${sessionId}/rated/movies?api_key=8490441a780d696323472e0a8e97e0ca&page=${page}`
    );
    return res.results;
  }
  ...
  async createGuestSession() {
    const res = await this.getResource(
      'https://api.themoviedb.org/3/authentication/guest_session/new?api_key=8490441a780d696323472e0a8e97e0ca'
    );
  ...
  async getMoviesGenres() {
    const res = await this.getResource(
      'https://api.themoviedb.org/3/genre/movie/list?api_key=8490441a780d696323472e0a8e97e0ca&language=en-US'
    );
    return res.genres;
  }
}
